...
Inspired by [uses.tech](https://uses.tech) where developers share their hardware/software/tools they use regularly. Here are my tools.
...
* Main editor: [VSCode](https://code.visualstudio.com/) (with Vim emulation)

  * [Monokai Pro](https://monokai.pro/) (filter Octagon) as a default dark theme, [GitHub Light Theme](https://github.com/yunlingz/vscode-theme-github-light) when I switch to light mode.
...
* [Arc](https://arc.net/) as a default browser, and [Chrome Canary](https://www.google.com/chrome/canary/) as a browser for development.

* [Raycast](https://www.raycast.com/) for shortcuts, windows management, etc.&#x20;
...
* [z](https://github.com/rupa/z) - since I know how to `z`, I never use `cd` again.
...
* [Cursor](https://cursor.sh/) is basically VSCode with AI features which I really liked. But paying 20$ a month for a code editor is still a no for me.

* [Alfred](https://www.alfredapp.com/) - I used Alfred for many years until I found Raycast. Thanks Alfred!

* [Kap](https://getkap.co/) is a screen recording app. Very minimal and easy to use.

---

## Hardware

* Computers: [13-inch Macbook Air M2](https://support.apple.com/en-us/111867) at work. At home I have a [2013 13-inch MakBook Pro](https://support.apple.com/kb/sp691?locale=th_TH), but it's rarely used nowadays.\
...
* Keyboard: Corne wireless split keyboard. I wrote about it here: [Building a Wireless Corne Keyboard](https://armno.in.th/blog/building-a-wireless-corne-keyboard/).\
  ![](../../pages/uses/content/corne-keyboard.jpg)
...
* Digital camera: Fujifilm XT-20 digital camera with TTArtisan 50mm f/1.2 manual focus lense\
  ![](../../pages/uses/content/fuji.jpg)

* Bike: [2022 Nich Faith 2](https://www.nichcycling.com/pages/faith2) road bike which I use for commuting to work and sometimes for a weekend long ride.\
