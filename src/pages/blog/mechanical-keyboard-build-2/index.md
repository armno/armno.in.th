...
<Picture wrapper-class="semi-full" ratio="16-9" src="images/kbdfans-5-degree-case.jpg" alt="case อลูมิเนียมจากร้าน kbdfans" />

เปลี่ยน keycap หลายๆ profile ข้างล่างนี้ลองใช้ DSA keycaps ที่ปุ่มจะสูงเท่ากับทุกแถว พิมพ์ง่ายดีเหมือนกัน

<Picture wrapper-class="semi-full" ratio="16-9" src="images/dsa-keycaps.jpg" alt="blank DSA keycaps" />

รื้อบอร์ดใหม่เพื่อเปลี่ยน plate หรือเปลี่ยน switch ก็มี

<Picture wrapper-class="semi-full lazy-wrapper" ratio="3-2" src="images/gateron-clears.jpg" alt="ลองใช้ switch Gateron Clears" />
...
<Picture wrapper-class="semi-full" ratio="3-2" src="images/mark1-mark2.jpg" alt="mark 1 กับ mark 2 ที่ทำมาเป็นฝาแฝดกัน" />
...
<Picture wrapper-class="semi-full" ratio="16-9" src="images/dz60-rgb.jpg" alt="ไฟ RGB Underglow ของ DZ60" />

-----

## Mark 4 (มาร์กโฟร์) {#mark-4}

<Picture wrapper-class="semi-full" ratio="16-9" src="images/mark-iv.jpg" alt="custom mechanical keyboard mark 4" />
...
<Picture wrapper-class="semi-full" ratio="3-2" src="images/mark4-layout.jpg" alt="Layout ของ Mark 4" />

<Picture wrapper-class="semi-full" ratio="3-2" src="images/mark4-3.jpg" alt="custom mechanical keyboard mark 4" />

### PCB: DZ60

<Picture wrapper-class="semi-full" src="images/mark4-layers.jpg" alt="ส่วนประกอบของ Mark 4" />
...
<Picture wrapper-class="semi-full" ratio="16-9" src="images/usb-adapter.jpg" alt="ต่อสาย USB จาก DZ60 Rev 2.0 ต้องใช้ adapter USB A-to-C" />
...
<Picture wrapper-class="semi-full" ratio="3-2" src="images/foam-pad.jpg" alt="รองด้วยแผ่นโฟมกันกระแทก ในเคส ใต้ PCB" />

น้ำหนักเฉพาะเคสก็ 800 กว่ากรัมแล้ว ประกอบเสร็จแล้วคีย์บอร์ดเล็กๆ นี่หนักตั้ง 1.2kg

<Picture wrapper-class="semi-full" ratio="3-2" src="images/keyboard-weight.jpg" alt="น้ำหนักรวมของ mark 4 อยู่ที่ประมาณ 1.2kg" />
...
<Picture wrapper-class="semi-full" ratio="3-2" src="images/mark4-switches.jpg" alt="switch ที่ใช้ใน mark 4" />
...
<Picture wrapper-class="semi-full" ratio="3-2" src="images/keycaps-profile.jpg" alt="SA profile จะสูงกว่าเพื่อนหน่อยๆ" />
...
<Picture wrapper-class="semi-full" src="images/foundation-keycaps.jpg" alt="MAXKEYS Foundation SA profile Keycaps" />
...
<Picture wrapper-class="semi-full" ratio="3-2" src="images/mark4-on-desk.jpg" alt="custom mechanical keyboard mark 4 บนโต๊ะทำงาน" />

ส่วน key mapping นั้นก็เหมือนเดิมกับ mark 1 ครับ

`LAYER 0`:

<Picture wrapper-class="semi-full" src="images/mark4-layer-0.png" alt="keymap layer 0 ของ mark 4" />

`LAYER 1`: เพิ่มปุ่มเพิ่ม/ลดแสงหน้าจอลงไป (ตรงเลข 1 กับ 2) เป็นปุ่มที่ผมใช้บ่อย

<Picture wrapper-class="semi-full" src="images/mark4-layer-1.png" alt="keymap layer 1 ของ mark 4" />

-----

## Mark 5 (มาร์กไฟฟ์) {#mark-5}

<Picture wrapper-class="semi-full" ratio="3-2" src="images/mark5.jpg" alt="custom mechanical keyboard mark 5 ของนีโม่" />
...
<Picture wrapper-class="semi-full" ratio="16-9" src="images/mark5-case.jpg" alt="case low profile ของ mark 5" />
...
<Picture wrapper-class="semi-full" ratio="16-9" src="images/mark5-switches.jpg" alt="switch แบบต่างๆที่ใช้ใน mark 5" />

- Keycaps: Black PBT, DSA Profile: เธอบอกว่าไม่ค่อยชอบเท่าไหร่ ชอบแบบของ MAXKEYS มากกว่า

<Picture wrapper-class="semi-full" ratio="3-2" src="images/mark5-with-sa-keycaps.jpg" alt="ลองเอา foundation keycaps ใส่กับ mark 5 ดู" />
...
<Picture wrapper-class="semi-full" src="images/mark5-layout-compare.jpg" alt="เทียบ layout กันระหว่าง mark 4 กับ mark 5" />
...
<Picture wrapper-class="semi-full" src="images/mark5-layer-0.png" alt="layer 0 ของ Mark 5" />

`LAYER 1`: ใส่ปุ่ม function keys: <kbd>F1</kbd> ถึง <kbd>F12</kbd> กับปุ่ม <kbd>printscreen</kbd> ที่เธอต้องใช้บ่อยๆ เข้าไปด้วย

<Picture wrapper-class="semi-full" src="images/mark5-layer-1.png" alt="layer 1 ของ Mark 5" />
