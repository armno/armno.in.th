...
<Picture wrapper-class="full" src="images/02-parts.jpg" alt="PCB GH60 Satan และของอื่นๆ ที่ซื้อมาจาก AliExpress" />
...
<Picture wrapper-class="full" src="images/03-check-pcb.jpg" alt="เช็คบอร์ด PCB GH60 ว่าใช้งานได้ปกติ" />
...
<Picture wrapper-class="full" src="images/04-costar-stabilizers.jpg" alt="Costar stabilizers ที่ตอนแรกได้แต่นั่งจ้อง" />
...
<Picture wrapper-class="full" src="images/05-install-switches.jpg" alt="เริ่มใส่ switch ตามมุมต่างๆ ก่อน" />
...
<Picture wrapper-class="full" src="images/06-test-switches-during-install.jpg" alt="ทดสอบ switch ไปพร้อมๆ กัน" />

สุดท้ายก็ได้พบว่า การบัดกรีจริงๆ แล้วไม่ได้น่ากลัวเลย พอทำไปเรื่อยๆ แล้วรู้สึกสนุกซะด้วยซ้ำ

<Picture wrapper-class="full" src="images/07-all-switches-installed.jpg" alt="ติด switch ครบทุกตัว" />
...
<Picture wrapper-class="full" src="images/08-installing-stabilizers.jpg" alt="ติด costar style stabilizers" />
...
<Picture wrapper-class="full" src="images/09-install-all-keycaps.jpg" alt="ติด keycap ลงไป เป็นอันเสร็จพิธี" />

เมื่อใส่ PBT blank keycap ที่ตั้งใจซื้อแบบสีล้วนมา ชอบที่มันดู minimal ดีครับ

<Picture wrapper-class="full" src="images/18-with-all-black-keycaps.jpg" alt="update: เมื่อใส่กับ blank PBT keycap สีดำ" />

## ลองใช้งาน

<Picture wrapper-class="full" src="images/17-updated-work-desk.jpg" alt="keyboard ใหม่ บนโต๊ะทำงาน" />
...
<Picture wrapper-class="full" src="images/11-spacebar-popout.jpg" alt="ปุ่ม spacebar ที่บางทีก็เด้งออกมา" />
...
<Picture wrapper-class="full" src="images/19-final-keyboard.jpg" alt="ภาพ keyboard พร้อม keycap แบบโล่งๆ" />
...
<Picture wrapper-class="full" src="images/12-layer-1.png" alt="layer 1" />

<Picture wrapper-class="full" src="images/13-layer-2.png" alt="layer 2" />

<Picture wrapper-class="full" src="images/14-layer-3.png" alt="layer 3" />
...
<Picture wrapper-class="full" src="images/15-flashing-firmware.png" alt="flash custom firmware" />

## สรุป

<Picture wrapper-class="full" src="images/20-updated-topview.jpg" alt="ภาพจากมุมบน" />
