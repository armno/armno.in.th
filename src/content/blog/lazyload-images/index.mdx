...
<Picture width="848" height="348" src="/images/lazyload-images/disable-javascript-in-devtools.png" alt="ปิด JavaScript ใน Chrome DevTools" />
...
<Picture width="1440" height="878" src="/images/lazyload-images/audit-results-before.png" alt="ก่อนใช้ LazyLoad คะแนน performance อยู่ที่ 73" />

หลัง

<Picture width="1440" height="878" src="/images/lazyload-images/audit-results-after.png" alt="หลังใช้ LazyLoad คะแนน performance อยู่ที่ 90" />
